...
export function getWorkspaceUsageMetrics({
  ...
  if (apiBilling) {
    ...
    return {
      ...
      aiTokensUsed: apiBilling.aiTokens?.used ?? 0,
      aiTokensLimit: apiBilling.aiTokens?.limit ?? 0,
      aiTokensPeriodLabel: apiBilling.aiTokens?.periodLabel ?? 'This month',
  ...
  return {
    ...
    aiTokensUsed: 0,
    aiTokensLimit: 0,
    aiTokensPeriodLabel: 'This month',
