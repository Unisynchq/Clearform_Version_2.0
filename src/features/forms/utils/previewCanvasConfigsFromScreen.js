...
export function previewCanvasConfigsFromScreen(screen) {
  ...
  switch (label) {
    ...
    case 'Upload':
      return {
        multiImageConfig: {
          question: c.multiImageQuestion ?? c.uploadQuestion,
          helperText: c.multiImageHelperText ?? c.uploadHelperText,
          maxFiles: c.multiImageMaxFiles,
          required: c.multiImageRequired ?? c.uploadRequired,
          multipleFiles: c.multiImageMultipleFiles,
          maxFileSize: c.multiImageMaxFileSize ?? c.uploadMaxFileSize,
          setQuestion: noop,
          setHelperText: noop,
        },
        uploadConfig: {
          question: c.uploadQuestion,
          helperText: c.uploadHelperText,
          maxFileSize: c.uploadMaxFileSize,
          setQuestion: noop,
          setHelperText: noop,
        },
      };
